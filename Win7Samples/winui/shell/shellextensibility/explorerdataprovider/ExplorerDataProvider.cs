...
namespace explorerdataprovider
{
	...
	public class CFolderViewImplFolder : IShellFolder2, IPersistFolder2
	{
		...
		public HRESULT GetDetailsEx(PIDL pidl, in Ole32.PROPERTYKEY pscid, out object pv)
		{
			...
			if (hr.Succeeded)
			{
				...
				{
					hr = GetColumnDisplayName(pidl, pscid, out pv, default, 0);
				}
			}
		...
		public HRESULT MapColumnToSCID(uint iColumn, out Ole32.PROPERTYKEY pkey)
		{
			...
			{
				case 0:
					pkey = Ole32.PROPERTYKEY.System.ItemNameDisplay;
					break;
				case 1:
