...
public class CFolderViewImplCategoryProvider : ICategoryProvider
{
	...
	public HRESULT EnumCategories(out IEnumGUID penum)
	{
		penum = new CFolderViewImplEnumGUID();
		return HRESULT.S_OK;
	}

	public HRESULT GetCategoryForSCID(in PROPERTYKEY pscid, out Guid pguid)
	{
		switch (pscid)
		{
	...
	public HRESULT GetDefaultCategory(out Guid pguid, out PROPERTYKEY pscid)
	{
		pguid = CAT_GUID_LEVEL;
		pscid = default;
		return HRESULT.S_OK;
