...
public static class FileRegistrations
{
	...
	public static HRESULT _RegSetString(HKEY hkey, string? pszSubKey, string? pszValue, string? pszData)
	{
		...
		return HRESULT_FROM_WIN32(SHSetValue(hkey, pszSubKey, pszValue, REG_VALUE_TYPE.REG_SZ));
	}

	public static bool AreFileTypesRegistered() => HRESULT_FROM_WIN32(RegOpenKey(HKEY.HKEY_CLASSES_ROOT, c_szProgID, out _)).Succeeded;
