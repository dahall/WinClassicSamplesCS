...
internal static partial class Program
{
	...
	)
	{
		...
		OPC_URI_TARGET_MODE targetMode = opcRelationship?.GetTargetMode() ?? throw new InvalidOperationException();
	...
	)
	{
		...
		GetRelationshipTargetPart(packagePartSet, relationship ?? throw new InvalidOperationException(), contentType, out partRead);
