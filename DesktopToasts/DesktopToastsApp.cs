...
public partial class DesktopToastsApp : Form
{
	...
	private void DisplayToast(object sender, EventArgs e)
	{
		...
		var imagePath = new Uri(Path.GetFullPath("toastImageAndText.png")).AbsoluteUri;
	...
	private void DisplayToastStatus(string message) => Invoke(() => { Activate(); Output.Text = message; });
}