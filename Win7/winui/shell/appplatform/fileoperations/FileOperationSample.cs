...
namespace fileoperations
{
	internal class Program
	{
		...
		private static void CreateSampleFolders(IShellItem psiSampleRoot, out IShellItem ppsiSampleSrc, out IShellItem ppsiSampleDst)
		{
			...
			pfo.NewItem(psiSampleRoot, System.IO.FileAttributes.Directory, c_szSampleSrcDir, null, null);
			pfo.NewItem(psiSampleRoot, System.IO.FileAttributes.Directory, c_szSampleDstDir, null, null);
			pfo.PerformOperations();
