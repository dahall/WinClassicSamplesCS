	...
	public partial class FullscreenMagnifierSample : Form
	{
		...
		private void SetZoom(float magnificationFactor)
		{
			...
			if (magnificationFactor >= 1.0)
			{
				...
				var xDlg = (int)((float)GetSystemMetrics(SystemMetric.SM_CXSCREEN) * (1.0 - (1.0 / magnificationFactor)) / 2.0);
				var yDlg = (int)((float)GetSystemMetrics(SystemMetric.SM_CYSCREEN) * (1.0 - (1.0 / magnificationFactor)) / 2.0);
